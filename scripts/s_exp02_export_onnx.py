"""
Export exp02 fine-tuned checkpoint to ONNX (static 1x3x224x224), saved as
models/trackpulse_classifier_v3_exp02.onnx (does NOT touch models/trackpulse_classifier.onnx
or the v2 file). Then verify numerical equivalence vs PyTorch on both the 49-image
racing eval set and RSCD 305-image test set.
"""
import os, json
import numpy as np
import torch
...
CKPT = f'{ROOT}/experiments/exp02_racing_v2/checkpoints/best_model.pth'
ONNX_OUT = f'{ROOT}/models/trackpulse_classifier_v3_exp02.onnx'
