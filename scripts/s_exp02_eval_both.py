"""
exp02 evaluation: run the fine-tuned checkpoint (PyTorch, GPU/CPU) on:
...
Same protocol as exp00/exp01's evaluation for direct comparability. No tuning
on the eval set - single run, honest report.
"""
import os, json
import numpy as np
import torch
...
print("\n=== RACING EVAL SET (49 images, quantitative on non-AMBIGUOUS) ===")
